...
export default function WinsCard() {
    return (
        <Link href="/soon" className="col-span-6">
            <div className="p-5 rounded-xl bg-surface border not-dark:shadow-md flex justify-between items-center text-sm h-84 group hover:border-blue-400 hover:cursor-pointer transition-colors duration-300">
