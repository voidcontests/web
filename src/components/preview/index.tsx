    ...
    return (
        <div
            ...
            className={cn(
                ...
                'prose-h1:pb-2.5 prose-h1:mb-4 prose-h1:text-2xl prose-h1:border-b',
                'prose-h2:pb-1.5 prose-h2:mb-4 prose-h2:text-xl prose-h2:border-b',
                'prose-h3:text-lg prose-h3:mt-6 prose-h3:mb-4',
                'prose-h4:text-base prose-h4:mt-6 prose-h4:mb-4',
                'prose-h5:text-sm prose-h5:mt-6 prose-h5:mb-4',
                'prose-h6:text-xs prose-h6:text-secondary-foreground prose-h6:mt-6 prose-h6:mb-4',
