    ...
    <ContentContainer>
      <div className="flex flex-col items-center w-full pt-8 gap-8">
        <h1 className="flex flex-col items-center">
          <span className="font-bold text-8xl leading-[90px] text-primary-text bg-linear-to-r from-[#7b84ff] to-[#2d83ec] text-transparent bg-clip-text text-center">
            THE VOID*
          </span>
          <span className="font-normal text-6xl leading-[75px] text-bright-text text-center">
            Avoid the void in your head
          </span>
        </h1>
        <p className="text-center text-lg text-primary-text max-w-xl">
